...
public person(String location, String name){
 ...
 m_name = name;
    ...
    public String getName() {
        //this public method can be accessed bu other classes and will return the value of the private property name
        //since we cannot access the private property directly from the thing. 
        return m_name;
    }
